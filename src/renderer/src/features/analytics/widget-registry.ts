...
const WIDGET_REGISTRY: readonly WidgetConfig[] = Object.freeze([
  {
    ...
    component: lazy(() => import('./widgets/DailyHoursChart'))
  },
  {
    id: 'hours-by-project',
    ...
    icon: PieChart,
    defaultSize: 'medium' as WidgetSize,
    component: lazy(() => import('./widgets/HoursByProjectChart'))
  },
  {
    id: 'hours-by-client',
    ...
    icon: PieChart,
    defaultSize: 'medium' as WidgetSize,
    component: lazy(() => import('./widgets/HoursByClientChart'))
  },
  {
    id: 'token-usage',
    title: 'Token Usage',
    icon: Zap,
    defaultSize: 'medium' as WidgetSize,
    component: lazy(() => import('./widgets/TokenUsageChart'))
  },
  {
    id: 'prompts-per-day',
  ...
  },
  {
    ...
    title: 'Billable Earnings',
    icon: Coins,
    defaultSize: 'medium' as WidgetSize,
    component: lazy(() => import('./widgets/BillableEarningsChart'))
  },
  {
    id: 'session-length',
    ...
    icon: Timer,
    defaultSize: 'medium' as WidgetSize,
    component: lazy(() => import('./widgets/SessionLengthChart'))
  },
  {
    id: 'peak-hours',
    title: 'Peak Hours',
    icon: Activity,
    defaultSize: 'medium' as WidgetSize,
    component: lazy(() => import('./widgets/PeakHoursChart'))
  },
  {
    id: 'work-vs-idle',
    title: 'AI vs Human Time',
    icon: Clock,
    defaultSize: 'medium' as WidgetSize,
