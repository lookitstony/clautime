...
function useGlowState(
  ...
  warningMin: number,
  alertMin: number
): { state: GlowState; idleSinceMs: number; isActive: boolean } {
  ...
  return {
    state: pastEntrance ? state : 'entrance',
    idleSinceMs: idleSince.current,
    isActive: nowActive
  }
}
...
const glowStyles: Record<GlowState, React.CSSProperties> = {
  entrance: {
    boxShadow: '0 0 3px 1px rgba(52, 211, 153, 0.8), inset 0 0 3px rgba(52, 211, 153, 0.15)',
    borderColor: 'rgba(52, 211, 153, 0.6)'
  },
  processing: {
    boxShadow: '0 0 4px 1px rgba(168, 85, 247, 0.8), inset 0 0 3px rgba(168, 85, 247, 0.15)',
    borderColor: 'rgba(168, 85, 247, 0.7)',
    animation: 'glow-breathe 2s ease-in-out infinite'
  },
  'prompt-ready': {
    boxShadow: '0 0 4px 1px rgba(96, 165, 250, 0.9), inset 0 0 3px rgba(96, 165, 250, 0.15)',
    borderColor: 'rgba(96, 165, 250, 0.7)',
    animation: 'glow-prompt-ready 0.8s ease-in-out 2'
  },
  active: {
    boxShadow: '0 0 3px 1px rgba(52, 211, 153, 0.7), inset 0 0 3px rgba(52, 211, 153, 0.1)',
    borderColor: 'rgba(52, 211, 153, 0.5)'
  },
  nudge: {
    boxShadow: '0 0 3px 1px rgba(52, 211, 153, 0.7), inset 0 0 3px rgba(52, 211, 153, 0.1)',
    borderColor: 'rgba(52, 211, 153, 0.5)',
    animation: 'glow-nudge 1.5s ease-in-out 3'
  },
  warning: {
    boxShadow: '0 0 3px 1px rgba(250, 204, 21, 0.7), inset 0 0 3px rgba(250, 204, 21, 0.1)',
    borderColor: 'rgba(250, 204, 21, 0.6)'
  },
  urgent: {
    boxShadow: '0 0 3px 1px rgba(250, 204, 21, 0.7), inset 0 0 3px rgba(250, 204, 21, 0.1)',
    borderColor: 'rgba(250, 204, 21, 0.6)',
    animation: 'glow-urgent-pulse 1s ease-in-out infinite'
  },
  alert: {
    boxShadow: '0 0 4px 1px rgba(248, 113, 113, 0.9), inset 0 0 3px rgba(248, 113, 113, 0.15)',
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="ml-auto flex items-center gap-1">
            <span className="font-mono text-[10px] font-semibold text-[var(--accent)]">
              {project.lastPromptAt ? (
                <LiveRelative epochMs={idleSinceMs} isProcessing={isActive} />
              ) : (
                '—'
              )}
            </span>
            <button
              type="button"
              onClick={() =>
                setWatching.mutate({ projectId: project.projectId, enabled: !project.isWatching })
              }
