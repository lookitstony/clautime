...
export function registerAiHandlers(): void {
  ipcMain.handle('ai:getMethod', async (): Promise<IpcResult<string>> => {
    try {
  ...
  ipcMain.handle('ai:setMethod', async (_event, method: string): Promise<IpcResult<void>> => {
    try {
  ...
  ipcMain.handle('ai:hasApiKey', async (): Promise<IpcResult<boolean>> => {
    try {
  ...
  ipcMain.handle('ai:storeApiKey', async (_event, key: string): Promise<IpcResult<void>> => {
    try {
  ...
  ipcMain.handle('ai:removeApiKey', async (): Promise<IpcResult<void>> => {
    try {
  ...
  ipcMain.handle('ai:testConnection', async (): Promise<IpcResult<boolean>> => {
    try {
