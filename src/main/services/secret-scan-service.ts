...
const PATTERN_DEFS: PatternDef[] = [
  // === LLM / AI providers ===
  { id: 'anthropic-api-key', label: 'Anthropic API Key', source: 'sk-ant-[a-zA-Z0-9\\-_]{20,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-anthropic-api-key' },
  { id: 'openai-api-key', label: 'OpenAI API Key', source: 'sk-proj-[a-zA-Z0-9\\-_]{20,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-openai-api-key' },
  { id: 'google-api-key', label: 'Google/Gemini API Key', source: 'AIzaSy[a-zA-Z0-9\\-_]{30,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-google-api-key' },
  { id: 'huggingface-token', label: 'HuggingFace Token', source: 'hf_[a-zA-Z0-9]{30,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-huggingface-token' },

  // === Cloud providers ===
  { id: 'aws-access-key', label: 'AWS Access Key', source: 'AKIA[0-9A-Z]{16}', flags: '', severity: 'critical', redactLabel: 'REDACTED-aws-access-key' },

  // === Cloud providers (continued) ===
  { id: 'aws-secret-key', label: 'AWS Secret Access Key', source: '(?:aws_secret_access_key|AWS_SECRET_ACCESS_KEY)\\s*[:=]\\s*["\']?[a-zA-Z0-9/+]{40}["\']?', flags: '', severity: 'critical', redactLabel: 'REDACTED-aws-secret-key' },
  { id: 'azure-devops-pat', label: 'Azure DevOps PAT', source: '[a-z0-9]{52}AZDO[a-z0-9]{24}', flags: '', severity: 'critical', redactLabel: 'REDACTED-azure-devops-pat' },
  { id: 'azure-client-secret', label: 'Azure Client Secret', source: '(?:client_secret|AZURE_CLIENT_SECRET)\\s*[:=]\\s*["\']?[a-zA-Z0-9~_.\\-]{34,}["\']?', flags: '', severity: 'critical', redactLabel: 'REDACTED-azure-client-secret' },
  { id: 'azure-storage-key', label: 'Azure Storage Key', source: 'DefaultEndpointsProtocol=https;AccountName=[^;]+;AccountKey=[^;]+', flags: '', severity: 'critical', redactLabel: 'REDACTED-azure-storage-key' },
  { id: 'gcp-service-account', label: 'GCP Service Account Key', source: '"type"\\s*:\\s*"service_account"', flags: '', severity: 'critical', redactLabel: 'REDACTED-gcp-service-account' },

  // === Code hosting / CI ===
  { id: 'github-pat', label: 'GitHub PAT', source: 'ghp_[a-zA-Z0-9]{36}', flags: '', severity: 'critical', redactLabel: 'REDACTED-github-pat' },
  { id: 'github-oauth', label: 'GitHub OAuth Token', source: 'gho_[a-zA-Z0-9]{36}', flags: '', severity: 'critical', redactLabel: 'REDACTED-github-oauth' },
  { id: 'github-app-token', label: 'GitHub App Token', source: 'ghu_[a-zA-Z0-9]{36}', flags: '', severity: 'critical', redactLabel: 'REDACTED-github-app-token' },
  { id: 'github-fine-grained', label: 'GitHub Fine-Grained PAT', source: 'github_pat_[a-zA-Z0-9_]{20,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-github-fine-grained' },
  { id: 'gitlab-pat', label: 'GitLab PAT', source: 'glpat-[a-zA-Z0-9\\-_]{20,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-gitlab-pat' },
  { id: 'bitbucket-app-password', label: 'Bitbucket App Password', source: 'ATBB[a-zA-Z0-9]{32,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-bitbucket-app-password' },

  // === Payment / SaaS ===
  { id: 'stripe-secret-key', label: 'Stripe Secret Key', source: 'sk_(?:live|test)_[a-zA-Z0-9]{20,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-stripe-secret-key' },
  { id: 'stripe-restricted-key', label: 'Stripe Restricted Key', source: 'rk_(?:live|test)_[a-zA-Z0-9]{20,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-stripe-restricted-key' },
  { id: 'twilio-api-key', label: 'Twilio API Key', source: 'SK[a-f0-9]{32}', flags: '', severity: 'critical', redactLabel: 'REDACTED-twilio-api-key' },
  { id: 'sendgrid-api-key', label: 'SendGrid API Key', source: 'SG\\.[a-zA-Z0-9\\-_]{20,}\\.[a-zA-Z0-9\\-_]{20,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-sendgrid-api-key' },
  { id: 'mailgun-api-key', label: 'Mailgun API Key', source: 'key-[a-f0-9]{32}', flags: '', severity: 'critical', redactLabel: 'REDACTED-mailgun-api-key' },
  { id: 'brevo-api-key', label: 'Brevo (Sendinblue) API Key', source: 'xkeysib-[a-f0-9]{64}-[a-zA-Z0-9]{16}', flags: '', severity: 'critical', redactLabel: 'REDACTED-brevo-api-key' },
  { id: 'resend-api-key', label: 'Resend API Key', source: 're_[a-zA-Z0-9]{20,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-resend-api-key' },

  // === BaaS / Database ===
  { id: 'supabase-key', label: 'Supabase Key', source: 'sbp_[a-f0-9]{40}', flags: '', severity: 'critical', redactLabel: 'REDACTED-supabase-key' },
  { id: 'firebase-key', label: 'Firebase Key', source: 'AAAA[a-zA-Z0-9_\\-]{7}:[a-zA-Z0-9_\\-]{140,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-firebase-key' },
  { id: 'planetscale-token', label: 'PlanetScale Token', source: 'pscale_tkn_[a-zA-Z0-9\\-_]{20,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-planetscale-token' },
  { id: 'planetscale-password', label: 'PlanetScale Password', source: 'pscale_pw_[a-zA-Z0-9\\-_]{20,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-planetscale-password' },

  // === Communication / Collaboration ===
  { id: 'slack-token', label: 'Slack Token', source: 'xox[bpas]-[a-zA-Z0-9\\-]{10,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-slack-token' },
  { id: 'slack-webhook', label: 'Slack Webhook', source: 'https?:\\/\\/hooks\\.slack\\.com\\/[^\\s"\']+', flags: '', severity: 'high', redactLabel: 'REDACTED-slack-webhook' },
  { id: 'discord-bot-token', label: 'Discord Bot Token', source: '[MN][a-zA-Z0-9\\-_]{23,}\\.[a-zA-Z0-9\\-_]{6}\\.[a-zA-Z0-9\\-_]{27,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-discord-bot-token' },
  { id: 'telegram-bot-token', label: 'Telegram Bot Token', source: '[0-9]{8,10}:[a-zA-Z0-9_\\-]{35}', flags: '', severity: 'critical', redactLabel: 'REDACTED-telegram-bot-token' },

  // === Hosting / CDN / Monitoring ===
  { id: 'netlify-token', label: 'Netlify Token', source: 'nfp_[a-zA-Z0-9]{40,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-netlify-token' },
  { id: 'datadog-api-key', label: 'Datadog API Key', source: 'dd[a-z][a-f0-9]{38}', flags: '', severity: 'critical', redactLabel: 'REDACTED-datadog-api-key' },
  { id: 'sentry-dsn', label: 'Sentry DSN', source: 'https?:\\/\\/[a-f0-9]{32}@[a-z0-9.]+\\.ingest\\.sentry\\.io\\/[0-9]+', flags: '', severity: 'high', redactLabel: 'REDACTED-sentry-dsn' },
  { id: 'newrelic-key', label: 'New Relic Key', source: 'NRAK-[a-zA-Z0-9]{27}', flags: '', severity: 'critical', redactLabel: 'REDACTED-newrelic-key' },
  { id: 'linear-api-key', label: 'Linear API Key', source: 'lin_api_[a-zA-Z0-9]{40,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-linear-api-key' },
  { id: 'doppler-token', label: 'Doppler Token', source: 'dp\\.(?:ct|pt|st|sa|scim|audit)\\.[a-zA-Z0-9_\\-]{2,35}\\.[a-zA-Z0-9]{40,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-doppler-token' },
  { id: 'digitalocean-token', label: 'DigitalOcean Token', source: 'do[por]_v1_[0-9a-f]{64}', flags: '', severity: 'critical', redactLabel: 'REDACTED-digitalocean-token' },
  { id: 'vault-token', label: 'HashiCorp Vault Token', source: 'hv[sbr]\\.[a-zA-Z0-9]{24,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-vault-token' },
  { id: 'fly-token', label: 'Fly.io Token', source: 'fm2_[a-zA-Z0-9+/=_\\-]{20,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-fly-token' },
  ...
  { id: 'groq-api-key', label: 'Groq API Key', source: 'gsk_[a-zA-Z0-9]{48,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-groq-api-key' },
  { id: 'railway-token', label: 'Railway Token', source: 'railway_[a-zA-Z0-9_\\-]{20,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-railway-token' },
  { id: 'render-api-key', label: 'Render API Key', source: 'rnd_[a-zA-Z0-9]{20,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-render-api-key' },
  { id: 'pinecone-api-key', label: 'Pinecone API Key', source: 'pcsk_[a-zA-Z0-9_]{40,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-pinecone-api-key' },

  // === Auth / Identity ===
  { id: 'okta-token', label: 'Okta API Token', source: '00[a-zA-Z0-9_-]{40}', flags: '', severity: 'critical', redactLabel: 'REDACTED-okta-token' },
  { id: 'auth0-client-secret', label: 'Auth0 Client Secret', source: '(?:auth0_client_secret|AUTH0_CLIENT_SECRET)\\s*[:=]\\s*["\']?[a-zA-Z0-9_\\-]{32,}["\']?', flags: '', severity: 'critical', redactLabel: 'REDACTED-auth0-client-secret' },
  { id: 'vercel-token', label: 'Vercel Token', source: 'vercel_[a-zA-Z0-9_\\-]{24,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-vercel-token' },
  { id: 'cloudflare-api-token', label: 'Cloudflare API Token', source: 'cf_[a-zA-Z0-9_\\-]{37,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-cloudflare-api-token' },

  // === Crypto / Keys / Generic ===
  { id: 'private-key', label: 'Private Key', source: '-----BEGIN\\s+(?:RSA |EC |DSA |OPENSSH )?PRIVATE KEY-----', flags: '', severity: 'critical', redactLabel: 'REDACTED-private-key' },
  { id: 'jwt-token', label: 'JWT Token', source: 'eyJ[a-zA-Z0-9_\\-]{20,}\\.[a-zA-Z0-9_\\-]{20,}\\.[a-zA-Z0-9_\\-]{20,}', flags: '', severity: 'high', redactLabel: 'REDACTED-jwt-token' },
  { id: 'connection-string', label: 'Connection String', source: '(?:mongodb\\+srv?|postgres(?:ql)?|mysql|redis|amqp):\\/\\/[^\\s"\'`]+', flags: '', severity: 'high', redactLabel: 'REDACTED-connection-string' },
  { id: 'bearer-token', label: 'Bearer Token', source: 'Bearer\\s+[a-zA-Z0-9\\-_.~+/]{20,}', flags: '', severity: 'high', redactLabel: 'REDACTED-bearer-token' },
  { id: 'npm-token', label: 'NPM Token', source: 'npm_[a-zA-Z0-9]{36}', flags: '', severity: 'critical', redactLabel: 'REDACTED-npm-token' },
  { id: 'pypi-token', label: 'PyPI Token', source: 'pypi-[a-zA-Z0-9\\-_]{50,}', flags: '', severity: 'critical', redactLabel: 'REDACTED-pypi-token' },
...
function validatePatternBroadness(source: string, flags: string): string[] {
  ...
  const broadPatterns = [
    ...
    { re: /^\[A-Z/, msg: 'Starts with a broad character class — consider adding a prefix anchor.' },
    { re: /^\[a-zA-Z/, msg: 'Starts with a broad character class — consider adding a prefix anchor.' }
  ]
  ...
  const commonWords = 'the quick brown fox jumps over the lazy dog hello world function return const var let import export class interface type true false null undefined'
  try {
    const regex = new RegExp(source, flags + 'g')
    const testMatches = commonWords.match(regex)
    if (testMatches && testMatches.length > 3) {
      warnings.push(`Pattern matches ${testMatches.length} common English words — very likely too broad.`)
    }
  } catch {
...
export const secretScanService = {
  ...
  async _runScanInner(): Promise<SecretScanResult> {
    ...
    for (const file of eligibleFiles) {
      ...
      try {
        ...
        db.delete(secretFindings)
          .where(eq(secretFindings.sourceFile, file.path))
          .run()
  ...
  async upsertCustomPattern(pattern: CustomSecretPattern): Promise<{ success: boolean; warnings: string[] }> {
    ...
    try {
      ...
      return { success: false, warnings: [`Invalid regex: ${err instanceof Error ? err.message : String(err)}`] }
    }
  ...
  testPattern(source: string, flags: string, testString: string): PatternTestResult {
    ...
    try {
      ...
      return { matches: [], matchCount: 0, warnings: [`Invalid regex: ${err instanceof Error ? err.message : String(err)}`] }
    }
